...
/*  void _getInitialInfo() {
  ...
  Future<void> invokeNativeActivity() async {
    ...
    return BottomNavigationBar(
      ...
      onTap: (value) => {
        setState(() {
          ...
          if (_selectedIndex == 1) {
            invokeNativeActivity();
          }
        })
      },
      items: [
        BottomNavigationBarItem(icon: Icon(null), label: "DART"),
        BottomNavigationBarItem(icon: Icon(null), label: "NATIVE")
      ],
      elevation: 20,
      backgroundColor: Color(0xe5b4ffdc),
    );
  }
